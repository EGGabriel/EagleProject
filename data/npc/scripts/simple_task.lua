...
npcHandler:say("Aos jovens aventureiros que querem acesso ao andar inferior, se provem, completando a task de {dragon}.", cid)
end
...
npcHandler:say("Parabéns, agora você está participando da missão task do "..msg..", falta matar "..string.sub(((contagem)-1)-tasktabble[msg].count, 2).." "..msg.."(s).", cid)
